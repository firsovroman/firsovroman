...
In Russian:
Уважаемые работодатели, к каждому из проектов я постарался дать изчерпывающее описание в файле README-file Все проекты я выполнял с целью самообучения. В принципе они все небольшие.
